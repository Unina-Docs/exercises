function [xv,iter]=myJacobi(A,b,x0,nmax,toll)
  % MYJACOBI 
  % Calcola la soluzione del sistema lineare Ax=b utilizzando il metodo iterativo di Jacobi.
  % [xv,iter]=myJacobi(A,b,x0,nmax,toll) calcola la soluzione del sistema lineare Ax=b con tolleranza toll
  ...
  %         [xv,iter]=myJacobi(A,b,zeros(8,1),30,1e-12)
